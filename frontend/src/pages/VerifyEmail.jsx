            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl max-w-md w-full text-center">
                ...
                {status === 'error' && (
                    <>
                        ...
                        <p className="text-slate-500 mt-2">The link is invalid or expired.</p>
                        <button onClick={() => navigate('/login')} className="mt-6 bg-slate-800 text-white px-6 py-2 rounded-lg">Go to Login</button>
                    </>
                )}
            </div>
        </div>
