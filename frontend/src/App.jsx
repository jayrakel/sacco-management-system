  ...
  return (
    <Router>
      <Routes>
        ...
        {/* Verification must be accessible without login */}
        <Route path="/verify-email" element={<VerifyEmail />} />

        {/* Catch bad links like /portal/verify-email */}
        ...
        {/* The /* allows nested routes inside dashboards if you add them later */}
